...
class SpouseBuilder():
    ...
    def compute_spouse_embeddings(self):

        for dataset_type in ['train', 'validation', 'test']:

            with open(Path(self.formatted_data_folder, f'spouse_formatted_{dataset_type}_finetune_dataset.pickle'), 'rb') as f:
